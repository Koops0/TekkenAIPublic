...
I then uploaded the images on [Roboflow](https://universe.roboflow.com/), where I create bounding boxes for objects, including enemies, players, their health, blocks and hits. Currently I'm 53% finished with the Validation dataset (79% in Total) and I expect object detection for all three datasets to be done by June 7th. This will probably be the longest part.
