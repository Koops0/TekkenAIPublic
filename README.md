...
From the 31 videos, I seperated them into 3 datasets: train, valid and test. I then created a Python script using OpenCV where I split the dataset into seperate frames. The amount of frames were around 3450 for Training, close to 1000 for Validation and 500 for Testing. This took a couple of hours.
